...
(function() {
  ...
  ready = function() {
    ...
    return $('.shap').hover(function(event) {
      return $(this).toggleClass("hover");
    });
  };
...
(function() {
  ...
  ready = function() {
    ...
    $('#menu_assigned_to_me').click(function(e) {
      $("tr.task").each(function(index, ele) {
        if ($(ele).children('.assignee').text() !== login_name) {
          return $(ele).remove();
        }
      });
      countTasks("TODO", "todo_counter");
      return countTasks("DOING", "doing_counter");
    });
    return $('#menu_created_by_me').click(function(e) {
      $("tr.task").each(function(index, ele) {
